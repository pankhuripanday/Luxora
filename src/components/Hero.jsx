    ...
    <div className='flex flex-col border border-gray-400 sm:flex-row'>
        ...
        <div className='text-[#414141]'>
            <div className='flex items-center gap-2'>
                ...
                <p className='text-sm font-medium md:test-base'>OUR HOTSELLERS</p>
            </div>
            <h1 className='text-3xl leading-relaxed prata-regular sm:py-3 lg:text-5xl'>Latest Additions</h1>
            <div className='flex items-center gap-2 '>
